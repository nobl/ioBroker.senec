...
const state_attr = {
	...
	vorname: { name: "First Name", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	nachname: { name: "Last Name", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	emailAdresse: { name: "Email Address", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	devNumber: { name: "Device Number", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	meterReadingVisible: {
		name: "Meter Reading Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	language: { name: "Language", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	// --- mein-senec.de System Info ---
	steuereinheitnummer: {
		name: "Serial Number",
		unit: "",
		booltype: false,
	...
	master: { name: "Master System", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	produktName: { name: "Product Name", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	statusVisible: { name: "Status Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	meterreadingVisible: {
		name: "Meter Reading Visible",
		unit: "",
		booltype: true,
	...
	autarkieVisible: { name: "Autarky Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	akkuVisible: { name: "Battery Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	statisticDataDownloadVisible: {
		name: "Statistics Download Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	technischeDatenVisible: {
		name: "Technical Data Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	zusatzpaketeVisible: {
		name: "Additional Packages Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	wartungsladungVisible: {
		name: "Maintenance Charge Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	serviceVisible: { name: "Service Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	zoneId: { name: "Timezone", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	senecCloudVisible: {
		name: "SENEC Cloud Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	offpeakVisible: { name: "Off-Peak Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	digitalAssistantVisible: {
		name: "Digital Assistant Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	wallboxVisible: { name: "Wallbox Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	senecOpenApiVisible: {
		name: "SENEC Open API Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	sgReadyVisible: { name: "SG-Ready Visible", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	emergencyPowerVisible: {
		name: "Emergency Power Visible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	// --- mein-senec.de Sockets (Steckdosen) ---
	steckdosenummer: { name: "Socket Number", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	steckdosennummer: {
		name: "Socket Number",
		unit: "",
		booltype: false,
	...
	switchedOn: { name: "Switched On", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	switchedOnToday: {
		name: "Switched On Today",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	mcuOperationalModeId: {
		name: "MCU Operational Mode ID",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	senecBatteryStorageGeneration: {
		name: "Battery Storage Generation",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	machine: { name: "Machine", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	lastupdated: { name: "Last Updated", unit: "", booltype: false, datetype: true, iptype: false, multiply: 1 },
	bearbeitungsdatum: {
		name: "Last Edit Date",
		unit: "",
		booltype: false,
	...
	valid: { name: "Valid", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	"peakShavingLocalEndTime.0": {
		name: "Peak Shaving Local End Hour",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"peakShavingLocalEndTime.1": {
		name: "Peak Shaving Local End Minute",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"bearbeiter.id": { name: "Editor ID", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"bearbeiter.aktiv": {
		name: "Editor Active",
		unit: "",
		booltype: true,
	...
	// --- mein-senec.de Maintenance ---
	"wartungsplan.minorMaintenancePossible": {
		name: "Minor Maintenance Possible",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"wartungsplan.maintenanceDueSoon": {
	...
	"wartungsplan.maintenanceOverdue": {
	...
	"wartungsplan.applicable": {
		name: "Maintenance Applicable",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	// --- SENEC.Connect (from /senec-connect/v1/systems/device-data/general) ---
	"battery.state": { name: "Battery State", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	...
	"battery.power": { name: "Battery Power", unit: "W", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"battery.voltage": {
	...
	"bessNameplate.model": { name: "Model", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"bessNameplate.serial_number": {
		name: "Serial Number",
		unit: "",
		booltype: false,
		datetype: false,
	...
	"bessNameplate.active_charge_power": {
	...
	"bessNameplate.active_discharge_power": {
	...
	"meter.grid_power": { name: "Grid Power", unit: "W", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"meter.consumption": {
	...
	"evse.id": { name: "Wallbox ID", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"evse.ev_connected": {
		name: "EV Connected",
		unit: "",
		booltype: true,
	...
	"evse.ev_charging": { name: "EV Charging", unit: "", booltype: true, datetype: false, iptype: false, multiply: 1 },
	"evse.charging_power": {
		name: "Charging Power",
		unit: "VA",
		booltype: false,
	...
	// --- DataAvailability (from /measurements/api/v1/systems/{id}/data-availability/timespan) ---
	periodStartDateInMilliseconds: {
		name: "Data Available From (ms)",
		unit: "ms",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	// --- ForecastChargingSettings (from /systems/api/v1/settings/forecast-charging-settings/{id}) ---
	chargingMode: { name: "Charging Mode", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	warrantyAccepted: {
		name: "Warranty Accepted",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	revocationPolicyAccepted: {
		name: "Revocation Policy Accepted",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	// --- OnlineState (from /systems/api/v1/{id}/online-state) ---
	state: { name: "Online State", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	since: { name: "Online Since", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	// id is already a generic key, will be created automatically by evalPoll
	// --- SystemStatus (from /systems/api/v1/status/{id}) ---
	name: { name: "System State Name", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	severity: { name: "System State Severity", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	firmwareVersion: {
	...
	guiVersion: { name: "GUI Version", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	lastContact: { name: "Last Contact", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	operatingMode: { name: "Operating Mode", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	// --- SystemDetails (from /systems/api/v1/{id}/details) ---
	"systemOverview.systemId": {
		name: "System ID",
		unit: "",
		booltype: false,
		datetype: false,
	...
	"systemOverview.installationDateTime": {
	...
	"systemOverview.exchangedSystemId": {
		name: "Exchanged System ID",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"casing.serial": { name: "Casing Serial", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"casing.temperatureInCelsius": {
	...
	"mcu.mainControllerUnitState.name": {
		name: "System State",
		unit: "",
		booltype: false,
		datetype: false,
	...
	"mcu.mainControllerUnitState.severity": {
		name: "System State Severity",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"mcu.mainControllerUnitState.operatingMode": {
		name: "Operating Mode",
		unit: "",
		booltype: false,
		datetype: false,
	...
	"mcu.guiVersion": { name: "GUI Version", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"mcu.lastContact.timestamp": {
		name: "MCU Last Contact",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"mcu.lastContact.severity": {
		name: "MCU Last Contact Severity",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"mcu.ipAddress": { name: "MCU IP Address", unit: "", booltype: false, datetype: false, iptype: false, multiply: 1 },
	"warranty.endDateTime": {
	...
	"batteryPack.numberOfBatteryModules": {
	...
	"batteryPack.currentChargingLevelInPercent": {
		name: "Charging Level",
		unit: "%",
		booltype: false,
		datetype: false,
	...
	"batteryPack.maxChargingPowerInKw": {
	...
	"batteryPack.maxDischargingPowerInKw": {
	...
	"batteryPack.remainingCapacityInPercent": {
		name: "Remaining Capacity (SOH)",
		unit: "%",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryPack.bmsFirmwareVersion": {
	...
	"batteryInverter.state.severity": {
		name: "Inverter State Severity",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryInverter.temperatures.amb": {
	...
	"batteryInverter.temperatures.max": {
	...
	"batteryInverter.temperatures.halfBridge1": {
		name: "Half Bridge 1 Temperature",
		unit: "°C",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryInverter.temperatures.halfBridge2": {
		name: "Half Bridge 2 Temperature",
		unit: "°C",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryInverter.temperatures.throttle": {
		name: "Throttle Temperature",
		unit: "°C",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryModules.state.severity": {
		name: "Module State Severity",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryModules.lastContact.timestamp": {
		name: "Module Last Contact",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryModules.lastContact.severity": {
		name: "Module Last Contact Severity",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"batteryModules.firmwareVersion": {
	...
	"installer.address.houseNumber": {
		name: "Installer House Number",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"installer.address.postcode": {
		name: "Installer Postcode",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"installer.address.timezone": {
		name: "Installer Timezone",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"installer.onlineMonitoringAllowed": {
		name: "Online Monitoring Allowed",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	// --- AMPACE ---
	"AMPACE.CELL_TEMPERATURES_MODULE_A": {
	...
	"AMPACE.CELL_TEMPERATURES_MODULE_B": {
	...
	"AMPACE.MODULE_ALARM_STATE": {
		name: "MODULE_ALARM_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.MODULE_FAULT_STATE": {
		name: "MODULE_FAULT_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.MODULE_WARNING_STATE": {
		name: "MODULE_WARNING_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_ALARM_STATE": {
		name: "RACK_ALARM_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_ALARM_STATE_POS": {
		name: "RACK_ALARM_STATE_POS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_FAULT_STATE": {
		name: "RACK_FAULT_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_FAULT_STATE_POS": {
		name: "RACK_FAULT_STATE_POS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_OFFLINE_STATUS": {
		name: "RACK_OFFLINE_STATUS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_RESERVED_DATA": {
		name: "RACK_RESERVED_DATA",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_WARNING_STATE": {
		name: "RACK_WARNING_STATE",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"AMPACE.RACK_WARNING_STATE_POS": {
		name: "RACK_WARNING_STATE_POS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.LOAD_IMBALANCE_ENABLED.0": {
		name: "Load imbalance enabled",
		unit: "",
		booltype: true,
		datetype: false,
	...
	"WALLBOX.LOAD_IMBALANCE_ENABLED.1": {
		name: "Load imbalance enabled",
		unit: "",
		booltype: true,
		datetype: false,
	...
	"WALLBOX.LOAD_IMBALANCE_ENABLED.2": {
		name: "Load imbalance enabled",
		unit: "",
		booltype: true,
		datetype: false,
	...
	"WALLBOX.LOAD_IMBALANCE_ENABLED.3": {
		name: "Load imbalance enabled",
		unit: "",
		booltype: true,
		datetype: false,
	...
	"WALLBOX.SMART_CHARGE_ACTIVE.0": {
		name: "Smart charge active 0",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SMART_CHARGE_ACTIVE.1": {
		name: "Smart charge active 1",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SMART_CHARGE_ACTIVE.2": {
		name: "Smart charge active 2",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SMART_CHARGE_ACTIVE.3": {
		name: "Smart charge active 3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SOCKET_ENABLED.1": {
		name: "WALLBOX.SOCKET_ENABLED 1",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SOCKET_ENABLED.2": {
		name: "WALLBOX.SOCKET_ENABLED 2",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SOCKET_ENABLED.0": {
		name: "WALLBOX.SOCKET_ENABLED 0",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.0": {
		name: "Device Inverter Enabled 0",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.1": {
		name: "Device Inverter Enabled 1",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.2": {
		name: "Device Inverter Enabled 2",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.3": {
		name: "Device Inverter Enabled 3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.4": {
		name: "Device Inverter Enabled 4",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.DEVICE_INV_ENABLED.5": {
		name: "Device Inverter Enabled 5",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.SG_READY_OVERWRITE_RELAY.1": {
		name: "SG_READY_OVERWRITE_RELAY 1",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.SG_READY_OVERWRITE_RELAY.0": {
		name: "SG_READY_OVERWRITE_RELAY 0",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.TECH_BUNDLE_INSTALLED": {
		name: "TECH_BUNDLE_INSTALLED",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WALLBOX.SOCKET_ENABLED.3": {
		name: "SOCKET_ENABLED 3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.isSgReadySupported": {
		name: "isSgReadySupported",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.hideWallboxComfortCharging": {
		name: "hideWallboxComfortCharging",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.hideWallboxSolarOptimizedCharging": {
		name: "hideWallboxSolarOptimizedCharging",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.hideWallboxSolarExertSettings": {
		name: "hideWallboxSolarExertSettings",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.hideWallboxSolarExpertSettings": {
		name: "hideWallboxSolarExpertSettings",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"capabilities.hideForecastBasedCharging": {
		name: "hideForecastBasedCharging",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"currently.powerConsumptionInW": {
		name: "powerConsumptionInW",
		unit: "W",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"currently.batteryChargeInW": {
		name: "batteryChargeInW",
		unit: "W",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"currently.batteryDischargeInW": {
		name: "batteryDischargeInW",
		unit: "W",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"currently.batteryLevelInPercent": {
		name: "batteryLevelInPercent",
		unit: "%",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"currently.selfSufficiencyInPercent": {
		name: "selfSufficiencyInPercent",
		unit: "%",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"today.powerGenerationInWh": {
		name: "powerGenerationInWh",
		unit: "Wh",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"today.powerConsumptionInWh": {
		name: "powerConsumptionInWh",
		unit: "Wh",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"today.batteryChargeInWh": {
		name: "batteryChargeInWh",
		unit: "Wh",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"today.batteryDischargeInWh": {
		name: "batteryDischargeInWh",
		unit: "Wh",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"today.selfSufficiencyInPercent": {
		name: "selfSufficiencyInPercent",
		unit: "%",
		booltype: false,
		datetype: false,
	...
	"SENEC_IO_OUTPUT.STECA_BUS_ENABLE": {
		name: "SENEC_IO_OUTPUT.STECA_BUS_ENABLE",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.BAT_MODULE_ENABLE_AMPACE": {
		name: "SENEC_IO_OUTPUT.BAT_MODULE_ENABLE_AMPACE",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.SYSTEM_CHARGE_CURRENT_LIMIT": {
		name: "SYSTEM_CHARGE_CURRENT_LIMIT",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"BMS.SYSTEM_DISCHARGE_CURRENT_LIMIT": {
		name: "SYSTEM_DISCHARGE_CURRENT_LIMIT",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_CONFDETECTION": {
		name: "WIZARD_CONFDETECTION",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_FINISHEDDETECTION": {
		name: "WIZARD_FINISHEDDETECTION",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_RESDETECTION": {
		name: "WIZARD_RESDETECTION",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_RS485ISO_INSTALLED": {
		name: "WIZARD_RS485ISO_INSTALLED",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_STARTDETECTION": {
		name: "WIZARD_STARTDETECTION",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_TIMEOUTDETECTION": {
		name: "WIZARD_TIMEOUTDETECTION",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"BMS.WIZARD_VAL_STATUS": {
		name: "WIZARD_VAL_STATUS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.STATUS_AC_SWITCH_IPU_V3": {
		name: "STATUS_AC_SWITCH_IPU_V3",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.ISOGUARD_STATUS": {
		name: "ISOGUARD_STATUS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.DRY_CONTACT_IN_IPU_V5": {
		name: "DRY_CONTACT_IN_IPU_V5",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.DC_HK_STATUS_IPU_V5": {
		name: "DC_HK_STATUS_IPU_V5",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.RCD_ERROR_IPU_V3": {
		name: "RCD_ERROR_IPU_V3",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_INPUT.AC_ERROR_IPU_V3": {
		name: "AC_ERROR_IPU_V3",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.BAT_MODULE_ENABLE_SAMSUNG_IPU_V5": {
		name: "BAT_MODULE_ENABLE_SAMSUNG_IPU_V5",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.BAT_MODULE_ENABLE_BMZ": {
		name: "BAT_MODULE_ENABLE_BMZ",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.FAULTLINE_DELAYED_DUALUSE": {
		name: "FAULTLINE_DELAYED_DUALUSE",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.ISOGUARD_ENABLE": {
		name: "ISOGUARD_ENABLE",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.AC_SWITCH_IPU_V3": {
		name: "AC_SWITCH_IPU_V3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.DRY_CONTACT_OUT_IPU_V5": {
		name: "DRY_CONTACT_OUT_IPU_V5",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.RCD_RESET_IPU_V3": {
		name: "RCD_RESET_IPU_V3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"SENEC_IO_OUTPUT.RCD_TEST_IPU_V3": {
		name: "RCD_TEST_IPU_V3",
		unit: "",
		booltype: true,
		datetype: false,
		iptype: false,
	...
	"WIZARD.TECH_BUNDLE_CODE_SGREADY": {
		name: "TECH_BUNDLE_CODE_SGREADY",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	"WIZARD.TECH_BUNDLE_CODE_SOCKETS": {
		name: "TECH_BUNDLE_CODE_SOCKETS",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
	...
	cascadeDevicesCount: {
		name: "Number of cascaded Devices",
		unit: "",
		booltype: false,
		datetype: false,
		iptype: false,
