...
class AdaptiveRequestQueue {
	 ...
	 * @param {function} [options.setTimeout] - timer factory (defaults to global setTimeout).
	 * @param {function} [options.clearTimeout] - timer clear function (defaults to global clearTimeout).
	 */
	constructor({
		concurrency = 2,
		minConcurrency = 1,
